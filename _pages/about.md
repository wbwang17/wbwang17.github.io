...
- ``ECCV 2024`` Fine-Grained Scene Graph Generation via Sample-Level Bias Prediction, Yansheng Li, Tingzhu Wang, Kang Wu, Linlin Wang, Xin Guo, **Wenbin Wang**, LNCS 15084, pp. 18-35, 2024. [![](https://img.shields.io/github/stars/Kenneth-Wong/TGIR?style=social&label=SBG)](https://github.com/Zhuzi24/SBG) 
